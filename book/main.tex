...
% Chapters 6 and 7 swapped (per user request 2026-04-15): SMC is now
% presented before Backstepping so that the book flows from direct
% robustness methods to recursive Lyapunov design.
\input{chapters/week_07}   % -> Chapter 6: Sliding Mode Control (Week 7)
\input{chapters/week_06}   % -> Chapter 7: Backstepping Control (Week 6)
