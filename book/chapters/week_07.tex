...
\subsubsection{Step 1 --- Stabilise the \textbackslash(x\_1\textbackslash) Subsystem (Virtual Control Design)}
...
\subsubsection{Step 2 --- Design the Actual Control \textbackslash(u\textbackslash) (Backstep)}
...
\subsection{Generalisation to \textbackslash(n\textbackslash)-Step Backstepping}
...
\subsubsection{Step 2 --- Design the Control Inputs \textbackslash((v, \textbackslash omega)\textbackslash)}
