...
\subsection{Recommended Approach (3-Hour Capstone)}

0:00 -- 0:20

\subsubsection{Week 11 Recall --- Navigation Control Exam Practice}

Review DWA vs MPC, AMCL state estimation, and parallels to the Kalman filter in LQG.

0:20 -- 1:00

\subsubsection{Comprehensive Controller Comparison}
...
\subsubsection{Industry Applications \& Case Studies}
...
\bottomrule\noalign{}
\endlastfoot
\textbf{Tracking Accuracy} & How closely the output follows the reference trajectory in the nominal (no uncertainty) case. & RMSE, \(\|e\|_\infty\) \\
